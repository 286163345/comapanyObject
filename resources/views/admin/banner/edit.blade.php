...
{{--                （由于服务器资源有限，所以此处每次给你返回的是同一张图片)--}}
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="link" name="href" autocomplete="off" class="layui-input" @if (!empty($banner['href'])) value="{{$banner['href']}}" @endif>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="desc" class="layui-form-label">描述</label>
                <div class="layui-input-inline">
                    <input type="text" id="desc" name="notes" autocomplete="off" class="layui-input" @if (!empty($banner['notes'])) value="{{$banner['notes']}}" @endif>
                </div>
