...
@section('content')
    <div class="layui-card-body ">
        <xblock>
            ...
            <button class="layui-btn" onclick="xadmin.open('添加','{{url('back/photoWall/create')}}',600,400)">
...
{{--                    </a>--}}
                    <button class="layui-btn layui-btn layui-btn-xs"  onclick='xadmin.open("编辑","{{url('back/photoWall/'.$value['id'].'/edit')}}",600,400)' ><i class="layui-icon">&#xe642;</i>编辑</button>
                    <button class="layui-btn-danger layui-btn layui-btn-xs del"  data-href="{{ url('back/photoWall',$value['id']) }}" href="javascript:;" ><i class="layui-icon">&#xe640;</i>删除</button>
                </td>
            </tr>
                @endforeach
            </tbody>
